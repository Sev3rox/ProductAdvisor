...
namespace webapp.Pages.ReviewsProduct
{
    public class DeleteModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(int? id)
        {
            ...
            ReviewProduct = await _context.ReviewProduct.FindAsync(id);

            if (ReviewProduct != null)
            {
                _context.ReviewProduct.Remove(ReviewProduct);
                await _context.SaveChangesAsync();
            }
             
            return RedirectToPage("../Products/Details", new { id = ReviewProduct.ProductID });
        }
    }
}
